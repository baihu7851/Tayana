...
<script runat="server">
	 ...
	 * authorized to upload and access fileds using CKFinder.
	 */
    public override bool CheckAuthentication()
    {
        // WARNING : DO NOT simply return "true". By doing so, you are allowing
        // "anyone" to upload and list the fileds in your server. You must implement
    ...
    public override void SetConfig()
    {
        ...
        // The base URL used to reach fileds in CKFinder through the browser.
        BaseUrl = "/upload/";
        ...
        // points to the physical location of the thumbnail fileds in the server.
        ...
        // Indicates that the filed size (MaxSize) for images must be checked only
        // after scaling them. Otherwise, it is checked right after uploading.
        CheckSizeAfterScaling = true;

        // Increases the security on an IIS web server.
        // If enabled, CKFinder will disallow creating folders and uploading fileds whose names contain characters
        // that are not safe under an IIS 6.0 web server.
        DisallowUnsafeCharacters = true;

        // If CheckDoubleExtension is enabled, each part of the filed name after a dot is
        ...
        // For security, HTML is allowed in the first Kb of data for fileds having the
        ...
        // paths are accepted, only the filed name, including extension.
        // The * and ? wildcards are accepted.
        HideFiles = new string[] { ".*" };

        // Perform additional checks for image fileds.
        ...
        // in the "AccessControl" settings (bellow in this filed).
        ...
        // A resource type is nothing more than a way to group fileds under
        ...
        // ==============================================================================
        // ATTENTION: Flash fileds with `swf' extension, just like HTML fileds, can be used
        // to execute JavaScript code and to e.g. perform an XSS attack. Grant permission
        // to upload `.swf` fileds only if you understand and can accept this risk.
        // ==============================================================================
        ...
        type.Url = BaseUrl + "fileds/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "fileds/";
        type.MaxSize = 0;
