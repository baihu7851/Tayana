...
namespace Tayana.backend.Utils
{
    /// <summary>
    /// 有關到頁面使用的類別
    /// </summary>
...

    {
        ...
        /// <remarks></remarks>
        public static void DoJavaScript(string javaScript)
        {
            var script = "";
        ...
        public static string LimitWord(object longString, int intLimitCount)
        {
            if (longString != null)
            {
        ...
        #endregion 限制字數的函式，適用於抓取資料庫資料，繫節時使用，會把NULL值換成空白顯示。
        ...
        /// <remarks></remarks>
        public static string CustomPageSql(int currentPage, int pageCount, string primaryKey, string selectField, string joinString, string whereString)
        {
        ...
        /// <remarks></remarks>
        public static string CustomPageRecordCount(string primaryKey, string joinString, string whereString)
        {
        ...
        /// <remarks></remarks>
        private static string Date2CrocFormat(DateTime dat)
        {
            return "民國" + (dat.Year - 1911).ToString() + "年" + dat.Month.ToString() + "月" + dat.Day.ToString() + "日";
        }

        #endregion "把該日期轉成民國XX年XX月XX日格式"
        ...
        /// <remarks></remarks>
        public static string Date2CrocWeekFormat(DateTime dat)
        {
            string Week = "";
            ...
            return $"民國{dat.Year - 1911}年{dat.Month}月{dat.Day}日 星期{Week}";
        }

        #endregion "把該日期轉成民國XX年XX月XX日 星期X 格式"
        ...
        /// <remarks></remarks>
        public static string TripleDesDecoding(byte[] byteEncryption)
        {
        ...
        /// <remarks></remarks>
        public static byte[] TripleDesEncryption(string noEncryptionString)
        {
            TripleDESCryptoServiceProvider tdes = new TripleDESCryptoServiceProvider();
            byte[] IV = { 228, 7, 39, 133, 31, 159, 107, 181 };
            byte[] key = { 168, 159, 239, 4, 198, 215, 9, 253, 248, 56, 191, 68, 140, 68, 230, 130, 27, 162, 182, 240, 52, 116, 130, 18 };
        ...
        public static string Eecoding(string cryString)
        {
            string strReturn = "";
        ...
        public static string Decoding(string encryptionString)
        {
        ...
        #endregion "Porting Common VB functions to C#: Asc()"
        ...
        #endregion "Porting Common VB functions to C#: Chr()"
